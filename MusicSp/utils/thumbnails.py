...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("MusicSp/assets/font2.ttf", 30)
        font = ImageFont.truetype("MusicSp/assets/font.ttf", 30)
        ...
        play_icons = Image.open("MusicSp/assets/play_icons.png")
